...
<html
  ...
  <head>
    ...
    <title>Customer Section - BanguBank</title>
  </head>
  <body class="h-full">
...
<?php if ( Application::$app->session->getFlash( 'success' ) ): ?>
  <section class="absolute left-0 right-0 px-6 py-3 mx-auto font-semibold text-center border rounded-lg bg-emerald-200 border-emerald-900 text-emerald-900 w-fit top-1/4">
    <?php echo Application::$app->session->getFlash( 'success' ); ?>
  </section>
<?php endif;?>

<?php if ( Application::$app->session->getFlash( 'error' ) ): ?>
  <section class="absolute left-0 right-0 px-6 py-3 mx-auto font-semibold text-center text-red-900 bg-red-200 border border-red-900 rounded-lg w-fit top-1/4">
